    ...
    <footer className="bg-obsidian text-pearl border-t border-gold-primary/20 pt-16 pb-8 px-6 md:px-12 w-full">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        ...
        <div className="flex flex-col items-start gap-4">
          ...
          <div className="flex gap-4 mt-2">
            <a 
              ...
              className="text-gold-primary hover:text-gold-light transition-colors flex items-center gap-1.5 text-xs font-mono uppercase tracking-wider" 
            ...
            >
              ...
              <span className="text-[10px]">laxmijewellerskhedbrahma</span>
            </a>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <a href="#locator" className="text-xs text-pearl/60 hover:text-gold-primary transition-colors">Find our Showroom</a>
        ...
        <div className="flex flex-col gap-4">
          <h4 className="font-serif text-sm tracking-wider uppercase text-gold-primary mb-6">Boutique Showroom</h4>
      ...
      <div className="max-w-7xl mx-auto pt-8 border-t border-pearl/10 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex gap-6 items-center">
          ...
          <a 
            href="/admin/login" 
            className="text-[10px] text-gold-primary/80 hover:text-gold-primary hover:underline transition-colors uppercase tracking-widest font-semibold font-mono"
